...
<div id="wa-widget" class="fixed bottom-6 right-6 z-50 flex flex-col items-end pointer-events-none">
    ...
    <button id="wa-toggle" type="button" class="pointer-events-auto w-14 h-14 md:w-16 md:h-16 bg-accent hover:bg-green-600 rounded-full flex items-center justify-center text-white shadow-elevated hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 relative cursor-pointer">
